...
func init() {
	t1 = NewNode(big.NewInt(0), big.NewInt(0), nil, nil)
	t2 = NewNode(big.NewInt(18), big.NewInt(0),
		NewNode(big.NewInt(15), big.NewInt(0), nil, nil), NewNode(big.NewInt(21), big.NewInt(0), nil, nil),
	)
	t3 = NewNode(big.NewInt(188), big.NewInt(0),
		NewNode(big.NewInt(155), big.NewInt(0),
			NewNode(big.NewInt(154), big.NewInt(0), nil, nil), NewNode(big.NewInt(156), big.NewInt(0), nil, nil),
		),
		NewNode(big.NewInt(210), big.NewInt(0),
			NewNode(big.NewInt(200), big.NewInt(0),
				NewNode(big.NewInt(199), big.NewInt(0), nil, nil), NewNode(big.NewInt(202), big.NewInt(0), nil, nil),
			),
			NewNode(big.NewInt(300), big.NewInt(0),
				NewNode(big.NewInt(211), big.NewInt(0), nil, nil), NewNode(big.NewInt(1560), big.NewInt(0), nil, nil),
			),
		),
	)
}
...
func TestSearch(t *testing.T) {
	n1 := NewNode(big.NewInt(154), big.NewInt(0), nil, nil)
	n2 := NewNode(big.NewInt(1560), big.NewInt(0), nil, nil)
	bst1 := NewNode(big.NewInt(188), big.NewInt(0),
		NewNode(big.NewInt(155), big.NewInt(0),
			n1, NewNode(big.NewInt(156), big.NewInt(0), nil, nil),
		),
		NewNode(big.NewInt(210), big.NewInt(0),
			NewNode(big.NewInt(200), big.NewInt(0),
				NewNode(big.NewInt(199), big.NewInt(0), nil, nil), NewNode(big.NewInt(202), big.NewInt(0), nil, nil),
			...
			NewNode(big.NewInt(300), big.NewInt(0),
				NewNode(big.NewInt(201), big.NewInt(0), nil, nil), n2,
			),
		),
	)
	assert.Equal(t, Search(bst1, big.NewInt(111)), (*Node)(nil), "search mismatch for unexistent node")
	assert.Equal(t, Search(bst1, big.NewInt(154)), n1, "search mismatch for node: ", n1)
	assert.Equal(t, Search(bst1, big.NewInt(1560)), n2, "search mismatch for node: ", n2)
}

func TestBasicOperations(t *testing.T) {
	bst1 := NewNode(big.NewInt(0), big.NewInt(0), nil, nil)
	bst2 := Insert(bst1, big.NewInt(1), big.NewInt(0))
	assert.Equal(t, []uint64{1, 0}, bst2.WalkKeysInOrder(), "different t2 keys")
	bst3 := Insert(bst1, big.NewInt(2), big.NewInt(0))
...
func TestBulkOperations(t *testing.T) {
	...
	t5 := NewNode(big.NewInt(4), big.NewInt(0),
		NewNode(big.NewInt(1), big.NewInt(0), nil, nil), NewNode(big.NewInt(5), big.NewInt(0), nil, nil),
	)
	assertAvl(t, t5, 2, []uint64{4, 1, 5})
	GraphAndPicture(t5, "t5")

	t6 := NewNode(big.NewInt(3), big.NewInt(0),
		NewNode(big.NewInt(2), big.NewInt(0), nil, nil), NewNode(big.NewInt(7), big.NewInt(0), nil, nil),
	)
	...
	t7 := NewNode(big.NewInt(18), big.NewInt(0),
		NewNode(big.NewInt(15), big.NewInt(0), nil, nil), nil,
	)
	assertAvl(t, t7, 2, []uint64{18, 15})
	GraphAndPicture(t7, "t7")

	t8 := NewNode(big.NewInt(11), big.NewInt(0), nil, nil)
	...
	t9 := NewNode(big.NewInt(2), big.NewInt(0),
		NewNode(big.NewInt(1), big.NewInt(0), nil, nil), NewNode(big.NewInt(3), big.NewInt(0), nil, nil),
	)
...
func TestUnion(t *testing.T) {
	...
	for _, b1 := range input1 {
		T1 = Insert(T1, big.NewInt(int64(b1)), big.NewInt(0))
	}
	assertAvl(t, T1, 4, []uint64{202, 64, 56, 60, 67, 241, 231, 228, 246})
	for _, b2 := range input2 {
		T2 = Insert(T2, big.NewInt(int64(b2)), big.NewInt(0))
	}
